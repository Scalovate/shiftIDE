...
Web console: shiftide.web.app · Company: scalovate.com
...
Web
Documentation — shiftide.web.app/docs with 11 guides (terminal, ShiftAI, workflows, Deploy Architect, Infra Hub, network/datacenter, shortcuts)
v1.2.1 — June 2026
...
Web: expanded marketing site including Private cloud page
...
Version 1.1.0 installer; see TESTING.md for manual matrix
Developer
npm run typecheck
npm run dist:win
v1.0.0 — June 2026
...
Web console
Hosted at shiftide.web.app on Firebase Hosting (Spark / free tier)
...
Links
Repository: github.com/rulhaq/shiftIDE
Web app: shiftide.web.app
shiftide-user-console shiftide-infra shiftide-settings shiftide-ai shiftide-commands shiftide-workflow shiftide-Main
